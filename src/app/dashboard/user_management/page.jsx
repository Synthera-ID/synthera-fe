            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3 min-w-0">
                  <div
                    className={`w-9 h-9 rounded-xl flex items-center justify-center font-bold text-[12px] shrink-0 ${user.avatarColor}`}
                  >
                    {user.avatar}
                  </div>
                ...
                <span>
                  <span
                    className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] font-bold border ${roleStyle.bg} ${roleStyle.text} ${roleStyle.border}`}
                  >
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-bg-2 border border-bg-3 rounded-3xl p-8 w-full max-w-sm shadow-2xl text-center">
        ...
        <p className="text-text-3 text-[13px] mb-6">
          Are you sure you want to delete <span className="text-text-1 font-semibold">{user.name}</span>? This action
          cannot be undone.
        </p>
