      ...
      <div className="bg-bg-2 border border-bg-3 rounded-2xl overflow-hidden">
        ...
        <div className="flex flex-col">
          {HISTORY_DATA.map((item, index) => (
            <div
              key={item.id}
              className={`grid grid-cols-[1.5fr_1fr_1fr_0.5fr] gap-4 px-7 py-5 items-center hover:bg-bg-3/30 transition-colors ${
                index !== HISTORY_DATA.length - 1 ? "border-b border-bg-3/60" : ""
              }`}
            >
